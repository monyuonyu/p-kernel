...
- **SS-4** function-preserving expert growth (cap_experts_of(N) sizes the router) · **SS-5** deterministic expert placement · **KV cache** (in flight; SS-6 prereq) → **SS-6** cross-node firing (remote experts on wide tokens, canonical fold order) · **SS-7** bigger baby. [all touch student.c — SERIAL]
