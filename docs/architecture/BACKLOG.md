...
| B3 | self-access R1 (first T1 affordance `self_access_publish` shipped+audited 2026-09-21, `feat/self-access-r1-publish`; crown grows +1560B x86/+1440B aarch64 bare-metal — re-bless is judgment-pending, not yet merged to master) | `30-module/self-access-design.md` R1 |
