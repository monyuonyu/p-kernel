 ...
 *
 *  WORD LIST v1: ENGLISH, 256 key words + 64 answer words (COMMANDER
 *  DECISION 1). Multilingual is a capacity follow-up; the manifesto
...
/* v1 dims = the LARGEST honestly-LEARNABLE real-word vocab at R_DM=32
 * (MEASURED, IX.0 #2). 256/64 collapses base recall; 8/32 learns. */
#define R3_VOCAB_KEYS   8       /* key words: the things a person asks ABOUT */
#define R3_VOCAB_VALS   32      /* answer words: the one-word answers        */
