...
| `41_shared_mind` ★ | 共有された心：A で教えた事実が B の重みから答えられる（region 限定・Path E・教師を kill しても生存） | §8+§9 |
...
### 07_network/01_net_infer — AI 推論 + UDP ネットワーク配信
...
### 07_network/02_http_get — HTTP GET (TCP クライアント)
...
### 07_network/03_multicast — UDP マルチキャスト
...
# 個別ビルド
make 01_posix/01_hello/hello.elf
make 01_posix/02_posix_io/posix_io.elf
make 01_posix/03_stdin_echo/stdin_echo.elf
make 01_posix/04_readdir/readdir.elf
make 02_rtos/01_rtos_task/rtos_task.elf
make 02_rtos/02_rtos_sync/rtos_sync.elf
make 02_rtos/03_mutex/mutex.elf
make 02_rtos/04_task_ext/task_ext.elf
make 03_ipc/01_mailbox/mailbox.elf
make 03_ipc/02_msgbuf/msgbuf.elf
make 03_ipc/03_rendezvous/rendezvous.elf
make 04_memory/01_mempool/mempool.elf
make 05_time/01_time/time.elf
make 05_time/02_cyc_alm/cyc_alm.elf
make 06_system/01_ref/ref.elf
make 06_system/02_misc/misc.elf
make 07_network/01_net_infer/net_infer.elf
make 07_network/02_http_get/http_get.elf
make 07_network/03_multicast/multicast.elf
```
