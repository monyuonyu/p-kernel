...
/*
 *	tm_com.c
 *	T-Monitor 互換ライブラリ 低レベル通信（AArch64 ベアメタルポート（QEMU virt））
 *
 *	PL011 シリアル（arch/aarch64/sio.c）へ接続します。
 */
...
/* 低レベルシリアル入出力（arch/aarch64/sio.c）
...
/*
 * 通信路の初期化（PL011 は boot/aarch64/main_mtk3.c で初期化済み）
 */
