...
/*
 *	cpudef.h
 *	CPU 依存定義（Windows x86-64 ネイティブポート依存部）
 *
...
/*
 * 汎用レジスタ（System V AMD64 ABI の callee-saved 相当のみ）
 */
typedef struct t_regs {
	VD	r[6];		/* r12, r13, r14, r15, rbx, rbp */
} T_REGS;
