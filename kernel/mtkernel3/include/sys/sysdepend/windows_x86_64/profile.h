...
/*
 *	profile.h
 *	サービスプロファイル定義（Windows x86-64 ネイティブポート依存部）
 *
 *	Linux ユーザモードポート（linux_x86_64/profile.h）と同値。
 *	特権命令・割込みコントローラ・キャッシュ制御などのハードウェア
 *	機能は使用できないため、対応プロファイルはすべて FALSE とします。
 */
